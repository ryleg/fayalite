...
export HADOOP_SSH_OPTS="-o StrictHostKeyChecking=no -o ConnectTimeout=5 -p 22221"
...
# VV is this even being used?? Docker image doesnt have a hadoop user and dfs doesn't seem to care.
